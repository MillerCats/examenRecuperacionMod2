...
public class MedicoJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.mycompany_ExamenRecuparacion_war_1.0-SNAPSHOTPU");
    ...
    public Medico findMedico(String dni) {
        EntityManager em = getEntityManager();
        try {
    ...
    public Medico validar(String dni, String passPlana) {
        Medico foundedCliente = findMedico(dni);
